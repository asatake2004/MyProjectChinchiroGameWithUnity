...
public class SVChinchiroManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("SVGameManagerが見つかりませんでした。SVChinchiroManagerが正しく動作しない可能性があります。");
        }
    }
    ...
    public void EvaluateDice(int[] diceValues)
    {
        ...
        svGameManager.AddPlayerScore(yaku);
    }
